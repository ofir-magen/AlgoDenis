...
export default function UsersPage({ auth }) {
  ...
  return (
    <div>
      {/* כותרת עליונה ייעודית לעמוד משתמשים: רענון, חיפוש, סה״כ */}
                  ...
                  <tr key={r.id}>
                          ...
                          <td key={key}>
                            {isEditing ? (
                              <select
                                ...
                                value={val ? "1" : "0"}
                                onChange={(e) =>
                                  changeDraft("approved", e.target.value === "1")
                                }
                              >
                          ...
                          <td key={key}>
                            {isEditing ? (
                              <select
                                ...
                                value={val ? "1" : "0"}
                                onChange={(e) =>
                                  changeDraft("affiliator", e.target.value === "1")
                                }
                              >
                                <option value="0">לא</option>
                                <option value="1">כן</option>
                          ...
                          <td key={key}>
                            {isEditing ? (
                              <input
                                ...
                                value={val ?? ""}
                                onChange={(e) =>
                                  changeDraft("price_nis", e.target.value)
                                }
                              />
                            ) : val == null ? (
                              ""
                    ...
                    <td className="actions">
                      {isEditing ? (
                        ...
                        <>
                          <button className="btn-primary sm" onClick={() => beginEdit(r)}>
                            ערוך
                          </button>
                          <button className="btn-danger sm" onClick={() => delRow(r.id)}>
                            מחק
                          </button>
                        </>
                      )}
